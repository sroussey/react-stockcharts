      ...
      <ContentSection title={VolumeBarPage.title}>
          ...
          <Section colSpan={2}>
            <aside
              dangerouslySetInnerHTML={{
                __html: require('md/VOLUME-BAR-INTRO'),
              }}></aside>
          </Section>
        </Row>
        <Row>
        ...
        <Row>
          <Section colSpan={2}>
            <aside
              dangerouslySetInnerHTML={{
                __html: require('md/VOLUME-BAR-Contd'),
              }}></aside>
          </Section>
        </Row>
        <Row>
        ...
        <Row>
          <Section colSpan={2}>
            <aside
              dangerouslySetInnerHTML={{
                __html: require('md/VOLUME-BAR-Contd2'),
              }}></aside>
          </Section>
        </Row>
      </ContentSection>
