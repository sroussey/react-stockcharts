...
const levelDefinition = [
  ...
  /* 19 */ (d, date, i) =>
    d.startOfYear && date.getFullYear() % 12 === 0 && 'yearFormat',
  /* 18 */ (d, date, i) =>
    d.startOfYear && date.getFullYear() % 4 === 0 && 'yearFormat',
  /* 17 */ (d, date, i) =>
    d.startOfYear && date.getFullYear() % 2 === 0 && 'yearFormat',
  ...
  /*  7 */ (d, date, i) =>
    d.startOfHour && date.getHours() % 2 === 0 && 'hourFormat', // 2h -- REMOVE THIS
...
export { defaultFormatters, levelDefinition };
