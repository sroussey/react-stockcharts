...
TriangleMarker.drawOnCanvas = (props, point, ctx) => {
  ...
  TriangleMarker.drawOnCanvasWithNoStateChange(props, point, ctx);
};
TriangleMarker.drawOnCanvasWithNoStateChange = (props, point, ctx) => {
  const { width } = props;
  const w = functor(width)(point.datum);
